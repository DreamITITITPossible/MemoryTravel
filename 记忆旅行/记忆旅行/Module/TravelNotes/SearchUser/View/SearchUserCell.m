...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        _fansLabel.font = kFONT_SIZE_12;
        _fansLabel.textColor = [UIColor colorWithRed:0.85 green:0.85 blue:0.85 alpha:1.0];
...
- (void)setRecommend:(RecommendModel *)recommend {
    ...
    _fansLabel.text = [NSString stringWithFormat:@"粉丝: %@", recommend.fans];
...
- (void)layoutSubviews {
    ...
    _nickNameLabel.frame = CGRectMake(_headImageView.x + _headImageView.width + 10, _headImageView.centerY - 15, nameWidth, 15);
    ...
    _fansLabel.frame = CGRectMake(_nickNameLabel.x, _headImageView.centerY + 6, 120, 12);

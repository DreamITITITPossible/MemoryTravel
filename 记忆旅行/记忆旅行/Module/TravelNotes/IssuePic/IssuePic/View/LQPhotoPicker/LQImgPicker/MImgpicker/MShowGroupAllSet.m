...
- (id)initWithGroup:(ALAssetsGroup *)group selectedArr:(NSMutableArray *)arrSelected {
    ...
    if (self = [super init]) {
        self.navigationItem.titleView = [UILabel getTitleViewWithTitle:[group valueForProperty:ALAssetsGroupPropertyName]];
...
- (void)viewDidLoad {
    ...
    [self changeTitle];
    rightBar.dk_tintColorPicker = DKColorPickerWithKey(TINT);
    self.navigationItem.rightBarButtonItem = rightBar;

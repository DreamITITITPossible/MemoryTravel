...
- (void)reloadData{
    ...
    if (nil != _datasource) {
        _numberOfItems = [_datasource numberOfItemInPageView:self];
...
- (NSMutableArray*)itemsArray{
    ...
    if (_itemsArray == nil) {
        NSInteger total = [_datasource numberOfItemInPageView:self];

...
>
{
    ...
    UIView *topView;
    UILabel *titleLbl;
    JiangCycleScrollView *yearScrollView;//年份滚动视图
    JiangCycleScrollView *monthScrollView;//月份滚动视图
    JiangCycleScrollView *dayScrollView;//日滚动视图
    JiangCycleScrollView *hourScrollView;//时滚动视图
    JiangCycleScrollView *minuteScrollView;//分滚动视图
    JiangCycleScrollView *secondScrollView;//秒滚动视图
...
- (void)setTimeBroadcastView
{
    ...
    topView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, kTopViewHeight)];
    topView.backgroundColor = _topViewColor;
    
    okBtn = [[UIButton alloc]initWithFrame:CGRectMake(SCREEN_WIDTH - 60, 0, 60, kTopViewHeight)];
    [okBtn setTitleColor:_buttonTitleColor forState:UIControlStateNormal];
    ...
    titleLbl = [[UILabel alloc]initWithFrame:CGRectMake(60, 0, SCREEN_WIDTH - 120, kTopViewHeight)];
    ...
    timeBroadcastView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, kTimeBroadcastViewHeight)];
    timeBroadcastView.dk_backgroundColorPicker = DKColorPickerWithKey(BTNGREENBG);
    ...
    UIView *beforeSepLine = [[UIView alloc] initWithFrame:CGRectMake(0, kTopViewHeight + (kTimeBroadcastViewHeight / 5), SCREEN_WIDTH, 1.5)];
    [beforeSepLine setBackgroundColor:[UIColor colorWithHexString:@"0xEDEDED"]];
    [timeBroadcastView addSubview:beforeSepLine];
    UIView *middleSepView = [[UIView alloc] initWithFrame:CGRectMake(0, kTopViewHeight + 2 * (kTimeBroadcastViewHeight / 5), SCREEN_WIDTH, kTimeBroadcastViewHeight / 5)];
    ...
    UIView *bottomSepLine = [[UIView alloc] initWithFrame:CGRectMake(0, kTopViewHeight + 4 * (kTimeBroadcastViewHeight / 5), SCREEN_WIDTH, 1.5)];
    ...
    [timeBroadcastView setFrame:CGRectMake(0, SCREEN_HEIGHT - 100, SCREEN_WIDTH, kDatePickerHeight)];
}
//设置年月日时分的滚动视图
- (void)setYearScrollView
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        yearScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(0, kTopViewHeight, SCREEN_WIDTH * 0.25, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerDateMode) {
        yearScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(0, kTopViewHeight, SCREEN_WIDTH * 0.34, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerYearMonthMode) {
        yearScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(0, kTopViewHeight, SCREEN_WIDTH * 0.5, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerDateHourMinuteMode) {
        yearScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(0, kTopViewHeight, SCREEN_WIDTH * 0.28, kTimeBroadcastViewHeight)];
    }
...
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        monthScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH * 0.25, kTopViewHeight, SCREEN_WIDTH * 0.15, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerDateMode) {
        monthScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH * 0.34, kTopViewHeight, SCREEN_WIDTH * 0.33, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerMonthDayMode) {
        monthScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH * 0, kTopViewHeight, SCREEN_WIDTH * 0.5, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerYearMonthMode) {
        monthScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH * 0.5, kTopViewHeight, SCREEN_WIDTH * 0.5, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerDateHourMinuteMode) {
        monthScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH * 0.28, kTopViewHeight, SCREEN_WIDTH * 0.18, kTimeBroadcastViewHeight)];
    }
...
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        dayScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH * 0.40, kTopViewHeight, SCREEN_WIDTH * 0.15, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerDateMode) {
        dayScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH * 0.67, kTopViewHeight, SCREEN_WIDTH * 0.33, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerMonthDayMode) {
        dayScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH * 0.5, kTopViewHeight, SCREEN_WIDTH * 0.5, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerDateHourMinuteMode) {
        dayScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH * 0.46, kTopViewHeight, SCREEN_WIDTH * 0.18, kTimeBroadcastViewHeight)];
    }
...
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        hourScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH*0.55, kTopViewHeight, SCREEN_WIDTH*0.15, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerTimeMode) {
        hourScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(0, kTopViewHeight, SCREEN_WIDTH*0.34, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerHourMinuteMode) {
        hourScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(0, kTopViewHeight, SCREEN_WIDTH*0.5, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerDateHourMinuteMode) {
        hourScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH*0.64, kTopViewHeight, SCREEN_WIDTH*0.18, kTimeBroadcastViewHeight)];
    }
...
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        minuteScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH*0.70, kTopViewHeight, SCREEN_WIDTH*0.15, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerTimeMode) {
        minuteScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH*0.34, kTopViewHeight, SCREEN_WIDTH*0.33, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerHourMinuteMode) {
        minuteScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH*0.5, kTopViewHeight, SCREEN_WIDTH*0.5, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerDateHourMinuteMode) {
        minuteScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH*0.82, kTopViewHeight, SCREEN_WIDTH*0.18, kTimeBroadcastViewHeight)];
    }
...
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        secondScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH*0.85, kTopViewHeight, SCREEN_WIDTH*0.15, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerTimeMode) {
        secondScrollView = [[JiangCycleScrollView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH*0.67, kTopViewHeight, SCREEN_WIDTH*0.33, kTimeBroadcastViewHeight)];
    }
...
- (void)setAfterScrollShowView:(JiangCycleScrollView *)scrollview  andCurrentPage:(NSInteger)pageNumber
{
...
#pragma mark jiangcyclescrollview delegate
#pragma mark jiangcyclescrollview databasesource
...
- (void)showHcdDateTimePicker
{
    ...
    [UIView animateWithDuration:0.3f delay:0 usingSpringWithDamping:0.8f initialSpringVelocity:0 options:UIViewAnimationOptionLayoutSubviews animations:^{
        ...
        [timeBroadcastView setFrame:CGRectMake(0, SCREEN_HEIGHT - kDatePickerHeight, SCREEN_WIDTH, kDatePickerHeight)];
...
-(void)dismissBlock:(DatePickerCompleteAnimationBlock)block{
    ...
    [UIView animateWithDuration:0.4f delay:0 usingSpringWithDamping:0.8f initialSpringVelocity:0 options:UIViewAnimationOptionLayoutSubviews animations:^{
        ...
        [timeBroadcastView setFrame:CGRectMake(0, SCREEN_HEIGHT, SCREEN_WIDTH, height)];

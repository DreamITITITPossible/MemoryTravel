...
- (UITableView *)baseSearchTableView
{
    if (!_baseSearchTableView) {
        ...
        baseSearchTableView.dk_backgroundColorPicker = DKColorPickerWithKey(BG);
...
- (void)setupHotSearchRectangleTags
{
    ...
    // 设置tableView背景颜色
    self.baseSearchTableView.dk_backgroundColorPicker = DKColorPickerWithColors(JYXColor(239, 239, 239, 1), [UIColor darkGrayColor]);
    // 清空标签容器的子控件

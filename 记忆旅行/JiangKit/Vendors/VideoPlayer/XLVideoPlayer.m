...
//        _playOrPauseBtn.contentMode = UIViewContentModeCenter;
        [_bottomBar addSubview:_playOrPauseBtn];
        
        NSLayoutConstraint *playBtnLeft = [NSLayoutConstraint constraintWithItem:_playOrPauseBtn attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:_bottomBar attribute:NSLayoutAttributeLeft multiplier:1.0f constant:10.f];
        NSLayoutConstraint *playBtnCenterY = [NSLayoutConstraint constraintWithItem:_playOrPauseBtn attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:_bottomBar attribute:NSLayoutAttributeCenterY multiplier:1.0f constant:0];
        
        NSLayoutConstraint *playBtnHeight = [NSLayoutConstraint constraintWithItem:_playOrPauseBtn attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeHeight multiplier:1.0f constant:20.0f];
        NSLayoutConstraint *playBtnWidth = [NSLayoutConstraint constraintWithItem:_playOrPauseBtn attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeWidth multiplier:1.0f constant:20.0f];
        [_bottomBar addConstraints:@[playBtnLeft, playBtnCenterY, playBtnHeight, playBtnWidth]];
        ...
        NSLayoutConstraint *label1Right = [NSLayoutConstraint constraintWithItem:label1 attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:_playOrPauseBtn attribute:NSLayoutAttributeRight multiplier:1.0f constant:0];
        ...
        [_bottomBar addConstraints:@[label1Right, label1Top, label1Bottom, label1Width]];
        ...
        NSLayoutConstraint *label2Right = [NSLayoutConstraint constraintWithItem:label2 attribute:NSLayoutAttributeRight relatedBy:NSLayoutRelationEqual toItem:fullScreenBtn attribute:NSLayoutAttributeLeft multiplier:1.0f constant:10.f];

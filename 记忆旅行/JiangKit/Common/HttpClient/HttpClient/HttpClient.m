...
- (void)GET:(NSString *)url body:(id)body headerFile:(NSDictionary *)headers response:(JYX_ResponseStyle)responseStyle isShowHub:(BOOL)isShow success:(successBlock)success failure:(failureBlock)failure {    // 启动系统风火轮
...
- (void)POST:(NSString *)url body:(id)body bodyStyle:(JYX_RequestStyle)bodyStyle headerFile:(NSDictionary *)headers response:(JYX_ResponseStyle)responseStyle isShowHub:(BOOL)isShow success:(successBlock)success failure:(failureBlock)failure {
    // 启动系统风火轮
    [UIApplication sharedApplication].networkActivityIndicatorVisible = YES;
    if (isShow) {
